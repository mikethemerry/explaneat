...
records that choice. [MIKE: adjust generations if you want a longer search.]
...
# deduplicated raw is stored under a distinct name. [MIKE: if that foreign
...
def get_or_create_raw(session, X, y):
    ...
    metadata = {
        "source_pinning": {
            ...
            "pmlb_data_commit": "[MIKE: pmlb package does not expose the data-repo "
